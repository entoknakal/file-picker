...
/**
 * Copy assets hook command for FilePicker plugin.
 *
...
{
    protected $signature = 'nativephp:file-picker:copy-assets';

    protected $description = 'Copy assets for FilePicker plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for FilePicker');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for FilePicker');
    }
}